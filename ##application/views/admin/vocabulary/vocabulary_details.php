<?php
	foreach($vocabularyDetails->result() as $ctD);
	$bid=$ctD->bid;
                                            	...
                                            	<table class="table table-bordered" width="100%">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                       <a href="<?php echo base_url('asset/uploads/vocabulary/'.$photo);?>">
                                             			<img src="<?php echo base_url('asset/uploads/vocabulary/'.$photo);?>" style="width:250px; height:auto" /></a></td>
                                                    </tr>
                                                </table>
                                            </div>
