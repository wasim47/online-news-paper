...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/approve?approve_val="+data+"&tablename=upcomming_album"+"&id=t_id"+"&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/deapprove?approve_val="+data+"&tablename=upcomming_album"+"&id=t_id"+"&status=status";
			window.details.href=hrefdata;
	}
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						<ul class="breadcrumb" style="font-size:20px;">
							<li>upcomming_album List</li>
                            <li>Total upcomming_album = <?php echo $upcomming_album_list->num_rows();?></li>
						</ul>

		  <ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/upcomming_album_registration');?>" class="btn btn-link btn-float has-text">
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-show-all" width="100%">
                                    ...
                                    <?php
									$i=0;
                                    foreach($upcomming_album_list->result() as $ctD):
									$t_id=$ctD->t_id;
									$name=$ctD->name;
									$details=$ctD->details;
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url('admin/upcomming_album_registration/'.$t_id);?>" style="color:#EDBB0E">
                                                    <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
                                                    <li><a href="<?php echo base_url('admin/upcomming_album_list?details='.$t_id);?>" style="color:#003399">
                                                    <i class="glyphicon glyphicon-file"></i> Details</a></li>
													<li><a href="javascript:void();" onclick="openPage1('<?php echo $t_id;?>','upcomming_album','t_id');" style="color:#ff0000">
