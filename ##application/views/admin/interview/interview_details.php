<?php
	foreach($interviewDetails->result() as $ctD);
	$bid=$ctD->bid;
                                            	...
                                            	<table class="table table-bordered" width="100%">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                       <a href="<?php echo base_url('asset/uploads/interview/'.$photo);?>">
                                             			<img src="<?php echo base_url('asset/uploads/interview/'.$photo);?>" style="width:250px; height:auto" /></a></td>
                                                    </tr>
                                                </table>
                                            </div>
