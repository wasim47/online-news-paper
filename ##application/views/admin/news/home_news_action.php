							...
							?>
                                   <div id="registration_form">	
                                        ...
                                        <div class="form-group" style="margin:0; padding:0; margin-bottom:5px;">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">All IDs (Comma separeted)</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="frmSearch">
                                                    <input type="text" required pattern="^\d{1,8}(,\d{1,8}){0,9}" 
                                                    title="Only Ten News ID Allow" id="search-box" name="row1" class="form-control col-md-7 col-xs-12" 
                                                    value="<?php echo $row1; ?>">
