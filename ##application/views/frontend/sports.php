                    ...
                    <div class="main_wrapper_bg">
                        ...
                        <div class="content_area">
                           ...
                           <div class="row">
                              ...
                              <div class="row">
                          	  	<div class="col-sm-12 col-md-12">
                                    <div class="title_area" style="margin-left:20px"><a href="javascript:void()">আপকামিং ম্যাচ</a></div>
                       		  ...
                       		  <div class="row">
                          	  <div class="col-sm-12 col-md-9">
                                    <div class="title_area" style="margin-left:20px"><a href="javascript:void()">এ সপ্তাহের আলোচিত তারকা</a></div>
                                    <div class="content-slider">
                                        <ul id="commonslider">
                                    <?php 
                                        ...
                                        <li>
                                        <div class="starinfo">                             
                                            <div class="imgarea"> <img src="<?php echo base_url('asset/uploads/players/'.$photo);?>" alt="<?php echo $playersname;?>" 
