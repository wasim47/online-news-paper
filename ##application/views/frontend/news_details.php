            ...
            <div class="col-sm-12 col-md-9">
                <div class="entertainment_section">
                 <div class="newsDetails">
                    ...
                    <a href="<?php echo base_url('news/index/'.$newsCatSlug);?>"><?php echo $newsCatName;?></a>
                            ...
                            <?php 
                                ...
                                ?>
                                 <div class="col-sm-12 col-md-3" style="min-height:200px;">
                                    <a href="<?php echo base_url("news/details/".$slugextra);?>">
                                    ...
                                    <div class="big_caption" style="margin-top:7px; float:left;">
                                        <a href="<?php echo base_url("news/details/".$slugextra);?>"><?php echo $title;?></a>
                                    </div>
                            </div>
                             <?php 
                                    }
