...
<div class="row">
		<div class="bottom_menu">
            ...
            <div class="col-sm-9 col-sm-offset-3">
            	<ul>
                	<li><a href="<?php echo base_url('actors/details/?i='.base64_encode($actorsid).'&&p='.base64_encode('biography'));?>">Biography</a></li>
                    <li><a href="<?php echo base_url('actors/details/?i='.base64_encode($actorsid).'&&p='.base64_encode('photos'));?>">Photos</a></li>
                    <li><a href="<?php echo base_url('actors/details/?i='.base64_encode($actorsid).'&&p='.base64_encode('videos'));?>">Videos</a></li>
                    <li><a href="<?php echo base_url('actors/details/?i='.base64_encode($actorsid).'&&p='.base64_encode('awards'));?>">Awards</a></li>
                </ul>
            </div>
            </div>
