...
<head>
    ...
    <link href="<?php echo base_url();?>asset/admin/datepicker/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css">

	
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/core/libraries/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/core/libraries/bootstrap.min.js"></script>
     <script type="text/javascript" src="<?php echo base_url();?>asset/admin/datepicker/bootstrap-datetimepicker.js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/plugins/pickers/daterangepicker.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/plugins/pickers/anytime.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/plugins/pickers/pickadate/picker.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/plugins/pickers/pickadate/picker.date.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/plugins/pickers/pickadate/picker.time.js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>asset/admin/js/pages/picker_date.js"></script>
