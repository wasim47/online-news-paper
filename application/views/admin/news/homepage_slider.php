							...
							<table class="table datatable-show-all" width="100%">
                                    <thead>
                                      <tr>
                                        ...
                                        <th width="16%">News Category</th>
                                        <th width="42%">News title</th>
                                   ...
                                   foreach($news_list->result() as $news):
									...
									?>
                                      <tr>
                                        ...
                                        <td width="2%"><input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>"  
                                            value="<?php echo $n_id;?>" /></td>
                                        <td><?php echo $crow['cat_name']; ?></td>
                                        <td><?php echo $headline; ?></td>
                                        <td>
		<input type="text" name="sequence" id="sequence<?php echo $n_id;?>" value="<?php echo $squence;?>" class="form-control" style="width:30%; float:left; text-align:center" />
        <input type="button" name="update" id="update" value="Save" class="btn btn-info btn-xs" onclick="update_sequence(<?php echo $n_id;?>);" />
                                        </td>
                                                ...
                                                <ul class="icons-list">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            <li><a href="<?php echo base_url('admin/news_action/'.$n_id);?>" style="color:#EDBB0E">
                                                            <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
                                                            <li><a href="javascript:void();" 
                                                            onclick="openPage1('<?php echo $n_id;?>','news_manage','n_id');" style="color:#ff0000">
