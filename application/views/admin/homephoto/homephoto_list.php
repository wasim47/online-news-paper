...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/approve?approve_val="+data+"&tablename=homephoto"+"&id=b_id"+"&status=active";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url('admin');?>/deapprove?approve_val="+data+"&tablename=homephoto"+"&id=b_id"+"&status=active";
			window.location.href=hrefdata;
	}
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						<ul class="breadcrumb" style="font-size:20px;">
							<li>Photo List</li>
                            <li>Total Photo = <?php echo $homephoto_list->num_rows();?></li>
						</ul>

						<ul class="breadcrumb-elements">
							<div class="heading-btn-group">
								<a href="<?php echo base_url('admin/homephoto_registration');?>" class="btn btn-link btn-float has-text">
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-show-all" width="100%">
                                    ...
                                    <?php
									$i=0;
										foreach($homephoto_list->result() as $pgdata):
										$b_id=$pgdata->b_id;
										$gtitle=$pgdata->homephoto_name;
										$gphoto=$pgdata->image;
									$i++;
									?>
                                      <tr>
                                        ...
                                        <td><img src="<?php echo base_url('asset/uploads/homephoto/'.$gphoto);?>" style="width:100px; height:auto" /></td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url('admin/homephoto_registration/'.$b_id);?>" style="color:#EDBB0E">
                                                    <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
													<li><a href="javascript:void();" onclick="openPage1('<?php echo $b_id;?>','homephoto','b_id');" style="color:#ff0000">
