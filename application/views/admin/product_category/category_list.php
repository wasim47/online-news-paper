...
function update_sequence(id){
	...
	window.location.href='<?php echo base_url('admin/update_sequence');?>?sequence='+updateid+"&&table=category&&colid=cid&&id="+id;
}
</script>
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						<ul class="breadcrumb" style="font-size:20px;">
							<li>Category List</li>
                            <li>Total Category = <?php echo $category_list->num_rows();?></li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-show-all" width="100%">
									...
									$position=$categoryData->menuPosition;
									if($active==1){
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url('admin/category_action/'.$cid);?>" style="color:#EDBB0E">
                                                    <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
													<li><a href="javascript:void();" onclick="openPage1('<?php echo $cid;?>','category','cid');" style="color:#ff0000">
