                                        ...
                                        <div class="panel panel-default">
											...
											if($adminUpdate->num_rows()>0){?>       
                                                <div class="form-group" id="user_access" <?php echo $style;?>>
                                                  ...
                                                  <input type="checkbox" name="userAccess[]" value="news" 
												  <?php if(in_array('news',$userAccess)){echo "checked";}?> /> &nbsp;&nbsp;News
                                                    <input type="checkbox" name="userAccess[]" value="homephoto" 
												  <?php if(in_array('homephoto',$userAccess)){echo "checked";}?> /> &nbsp;&nbsp;Homepae Photo Gallery<br>
                                                  <input type="checkbox" name="userAccess[]" value="photo" 
												  <?php if(in_array('photo',$userAccess)){echo "checked";}?> /> &nbsp;&nbsp;Photo Gallery<br>
                                                  <input type="checkbox" name="userAccess[]" value="video" 
												  <?php if(in_array('video',$userAccess)){echo "checked";}?> /> &nbsp;&nbsp;Video Gallery<br>
                                                  <input type="checkbox" name="userAccess[]" value="menu" 
												  <?php if(in_array('menu',$userAccess)){echo "checked";}?> > &nbsp;&nbsp;Additional Menu<br>
                                                  <input type="checkbox" name="userAccess[]" value="content" 
												  <?php if(in_array('content',$userAccess)){echo "checked";}?> > &nbsp;&nbsp;Website Content<br>
                                            ...
                                            <div class="form-group" id="user_access" style="display:none">
                                                ...
                                                <div class="col-sm-3">
                                                  ...
                                                  <input type="checkbox" name="userAccess[]" value="homephoto"> &nbsp;&nbsp;Homepae Photo Gallery<br>
                                                  ...
                                                  <input type="checkbox" name="userAccess[]" value="menu"> &nbsp;&nbsp;Additional Menu<br>
                                                  <input type="checkbox" name="userAccess[]" value="content"> &nbsp;&nbsp;Website Content<br>
                                                </div>
