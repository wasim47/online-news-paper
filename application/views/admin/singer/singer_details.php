<?php
	foreach($singerDetails->result() as $ctD);
	$user_id=$ctD->user_id;
                                            	...
                                            	<table class="table table-bordered" width="100%">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                       <a href="<?php echo base_url('asset/uploads/singer/'.$photo);?>">
                                             			<img src="<?php echo base_url('asset/uploads/singer/'.$photo);?>" style="width:250px; height:auto" /></a></td>
                                                    </tr>
                                                </table>
                                            </div>
