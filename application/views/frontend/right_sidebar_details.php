...
<div class="userinfo_right">
    ...
    <li class="active"><a href="#popular" role="tab" data-toggle="tab"> সম্পর্কীত  সংবাদ</a></li>
    <li><a href="#recent" role="tab" data-toggle="tab">সর্বশেষ সংবাদ</a></li>
    ...
    <div class="tab-pane active" id="popular">
      <ul class="list-unstyled">
        <?php
        foreach($rel_news->result() as $popular):
        ...
        <li> 
            <div class="col-sm-4 col-md-4" style="margin:0; padding:0">
                <img src="<?php echo base_url();?>asset/uploads/news/<?php echo $image_shortnat; ?>" alt="<?php echo $titlenat; ?>"
                 class="img-thumbnail"/> 
            </div>
            <div class="col-sm-8 col-md-8">
              <h4><a href="<?php echo base_url();?>details/<?php echo $intslug;?>"><?php echo $titlenat; ?></a></h4>
              <div class="newsdate">
      ...
      <ul class="list-unstyled">
        ...
        ?>
            ...
            <li> 
                ...
                <div class="col-sm-8 col-md-8">
                  <h4><a href="<?php echo base_url();?>details/<?php echo $intslugl;?>"><?php echo $titlenatl; ?></a></h4>
                  <div class="newsdate">
