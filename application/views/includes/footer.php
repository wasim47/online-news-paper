    	...
    	<div class="container">
            ...
            <div class="footer_area">
              ...
              <div class="col-sm-12 col-xs-12" style="background:#f5f5f5; border-top:1px solid #ccc; padding-bottom:30px">
                 ...
                 <div class="col-sm-4 col-xs-12">
                	<h2 style="padding:10px 10px 0 10px; margin:10px 10px 2px 80px; font-size:20px;"> ভারপ্রাপ্ত প্রকাশক </h2>
                    <p style="margin-left:110px;"> মাকসুদুল বারী স্বপন </p>
                </div>
                 <div class="col-sm-4 col-xs-12 pull-right">
                    <div class="f-title">আমাদের সাথে থাকুন</div>
                    <div class="top_menu" style="text-align:center">
                         <a href="https://www.facebook.com/geebd/" class="facebook" target="_blank"> <span class="fa fa-facebook" style="font-size:20px;"></span></a>
                         <a href="https://twitter.com/#" class="twitter" target="_blank"> <span class="fa fa-twitter" style="font-size:20px;"></span></a>
                         <a href="https://www.youtube.com/#" class="youtube" target="_blank"> <span class="fa fa-youtube" style="font-size:20px;"></span></a>
                         <a href="https://plus.google.com/#" class="gplus" target="_blank"> <span class="fa fa-google-plus" style="font-size:20px;"></span></a>
            ...
            <div class="col-sm-12 col-xs-12" style="margin:0; padding:0">
            	...
            	<div class="col-sm-8 col-xs-12 pull-left">
                    <p style="margin-top:10px;">
                      ২৩৮/১ আউটার সার্কুলার রোড, মৌচাক মার্কেট, তৃতীয় তলা, মারুফ মার্কেট চক্র, ঢাকা ১২১৭, বাংলাদেশ। ফোনঃ ০২৯৩৫১৪১০, ৯৩৫২১০২,
                 মোবাইলঃ ০১৭১২৫৭১০৯৮, ০১৯৩০২৯৫৯২৯ ইমেইলঃ 
                        <span style="font-family:Arial, Helvetica, sans-serif; font-size:16px;"> geebdnews@hotmail.om  </span> </p>
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs pull-right">
                        <a href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/images/logo.gif');?>" style="width:100%; height:auto" /></a> </div>
            </div>
        </div>
        </div>
 </div>
 <div class="row" style="margin-bottom:30px;">
 <div style="background:rgba(37,37,37,0.7);; padding:8px; text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#fff">© Copyright 2017. GEE BD. Designed and Developed by <a href="htt://softxmagic.com" target="_blank" style="color:#de5145">GEE IT</a></div>
 </div>
