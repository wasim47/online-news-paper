			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo base_url('asset/uploads/admin/'.$this->session->userdata('userAccessPhoto'));?>" 
                        alt="<?php echo $this->session->userdata('userAccessName');?>">
			...
			<div class="sidebar sidebar-main">
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
                    	<?php if($this->session->userdata('userAdminType')=='SubAdmin' && $this->session->userdata('userAccess')!=""){
						...
						<div class="category-content no-padding">
							...
							<ul class="navigation navigation-main navigation-accordion">
                               ...
                               <?php } ?>
                               <?php if(in_array('news',$userAccess)){?>
                                 <li>
                            ...
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <?php if(in_array('photo',$userAccess)){?>
                                ...
                                <?php } ?>        
                                <?php if(in_array('homephoto',$userAccess)){?>
                                <li>
                                ...
                                <?php } ?>        
                                <?php if(in_array('video',$userAccess)){?>
                                <li>
